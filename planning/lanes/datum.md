...
- [ ] Confirm the CI firmware build is green; nothing local can compile it.
...
- 2026-08-18: ESPHome not installed locally; firmware compile is unverified
  until .github/workflows/firmware.yml runs on the pull request.
